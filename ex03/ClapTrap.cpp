...
ClapTrap::ClapTrap() :_name(), _hitPoints(10), _energyPoints(10), _attackDamage(5)
{
    std::cout << "CLAPTRAP Default Constructor called" << std::endl;
};

ClapTrap::ClapTrap(const std::string &player) : _name(player), _hitPoints(10), _energyPoints(10), _attackDamage(5)
{
